        ...
        <form method="get" action="index.php" id="category-form">
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td class="inputfield"><div id="photo-category-select">{$categorySelect}</div></td>
        ...
        <form method="get" action="search.php" id="search-form">
          <table border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td class="inputfield">
                <input class="photoinput search-field" type="text" id="search_terms" 
...
{include file="findInclude:common/templates/springboard.tpl" springboardItems=$photos resultsID="photosList" titleTruncate=40}
