...
abstract class WebModule extends Module {
  ...
  private function loadBreadcrumbs() {
    ...
    if (!($this->id == 'home' && $this->page == 'index')) {
      ...
      if (!count($breadcrumbs)) {
        ...
        if ($firstBreadcrumb['p'] && $firstBreadcrumb['p'] != 'index'
            && $firstBreadcrumb['m'] && $firstBreadcrumb['m'] != 'home') {
          $addModuleHome = true;
        }
      }
      if ($addModuleHome) {
    ...
    foreach ($breadcrumbs as $i => $b) {
      ...
      $breadcrumbs[$i]['url'] = '/';
      $breadcrumbs[$i]['url'] .= ($b['p'] != 'index') ? $b['m'].'/'.$b['p'] : $b['m'].'/';
      if (strlen($b['a'])) {
  ...
  private function setPageVariables() {
    ...
    $this->assign('isModuleHome', ($this->id === 'home' && $this->page == 'index'));
